      ...
      cards: [
        {
          catalog: 'spoken',
          language: 'en-US',
          content: '<speak><prosody rate="medium" pitch="medium">Welcome to the QTI 3.0 test assessment. <break time="500ms"/> This assessment demonstrates context declarations, accessibility catalogs, and personal needs profiles.</prosody></speak>'
        },
        {
          catalog: 'spoken',
          language: 'es-ES',
          content: '<speak><prosody rate="medium">Bienvenido a la evaluación de prueba QTI 3.0.</prosody></speak>'
        },
        {
          catalog: 'braille',
          language: 'en',
        ...
        },
        {
          ...
          language: 'en',
          content: '<p>Welcome to the test. This test shows new QTI 3.0 features.</p>'
        }
      ]
    },
      ...
      cards: [
        {
          catalog: 'spoken',
          language: 'en-US',
          content: '<speak><prosody rate="slow">Read each question carefully. <break time="800ms"/> Select the best answer from the choices provided. <break time="500ms"/> You may use the available tools to help you answer.</prosody></speak>'
        },
        {
          catalog: 'simplified-language',
          language: 'en',
          content: '<div><p><strong>What to do:</strong></p><ol><li>Read each question</li><li>Pick the best answer</li><li>Use tools if you need help</li></ol></div>'
        }
      ]
    },
      ...
      cards: [
        {
          catalog: 'spoken',
          language: 'en-US',
          content: '<speak><prosody rate="slow">Two x <break time="200ms"/> plus five <break time="300ms"/> equals <break time="200ms"/> seventeen</prosody></speak>'
        },
        {
          catalog: 'braille',
          language: 'en',
          ...
          rubricBlocks: [
            {
              view: 'candidate',
              use: 'instructions',
              content: '<div data-catalog-id="welcome-message"><h3>Welcome</h3><p>This is a QTI 3.0 compliant assessment demonstrating accessibility catalogs, context declarations, and personal needs profiles.</p></div>'
            },
            {
              view: 'candidate',
              use: 'instructions',
              content: '<div data-catalog-id="test-instructions"><h4>Instructions</h4><p>Read each question carefully and select the best answer.</p></div>'
            }
          ],
...
console.log('  - accessibilityCatalogs:', qti3TestAssessment.accessibilityCatalogs?.length);
console.log('  - personalNeedsProfile:', qti3TestAssessment.personalNeedsProfile ? 'enabled' : 'not configured');
console.log('  - stimulusRefs:', qti3TestAssessment.stimulusRefs?.length, '(Phase 3 - placeholder)');
