...
const demo: DemoInfo = {
	...
	description:
		"Four-category grid with calculus formulas and multiple placements",
			...
			models: [
				{
					...
					prompt:
						"<p>Categorize these calculus formulas by type. Some formulas can be used multiple times.</p>",
					promptEnabled: true,
					categories: [
						{
							id: "0",
