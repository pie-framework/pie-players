			...
			models: [
				{
					...
					prompt:
						"<p>Classify each shape as 2D (two-dimensional) or 3D (three-dimensional) based on their formulas.</p>",
					promptEnabled: true,
					categories: [
						{
							id: "0",
							label:
								'<div style="text-align:center;"><strong>2D Shapes</strong><br/><small>Area formulas</small></div>',
						},
						{
							id: "1",
							label:
								'<div style="text-align:center;"><strong>3D Shapes</strong><br/><small>Volume formulas</small></div>',
						},
					],
					categoriesPerRow: 2,
