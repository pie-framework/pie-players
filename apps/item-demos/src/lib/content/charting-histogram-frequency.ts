...
const demo: DemoInfo = {
	...
	description:
		"Histogram showing frequency distribution with all editable categories",
			...
			models: [
				{
					...
					rationale:
						'<p>To make the frequencies sum to 50:<br/>Original sum: 6 + 10 + 9 + 5 + 10 + 8 = 48<br/>We need: 6 + 10 + 9 + 8 + 12 + 5 = 50<br/>Changed "3-4 hours" from 5 to 8 (+3), "5-6 hours" from 10 to 12 (+2), and "7+ hours" from 8 to 5 (-3) to balance the total.</p>',
