...
const demo: DemoInfo = {
	...
	description:
		"Line chart with cross markers showing exponential plant growth over time",
			...
			models: [
				{
					...
					promptEnabled: true,
					teacherInstructions:
						"<p><strong>Answer Key:</strong> Week 4: h(4) = 2(4) + 3 = 11 cm. Week 5: h(5) = 2(5) + 3 = 13 cm. Students should add these two data points to complete the growth pattern.</p>",
					...
					rationale:
						"<p>Using the formula h(t) = 2t + 3:<br/>Week 4: h(4) = 2(4) + 3 = 8 + 3 = 11 cm<br/>Week 5: h(5) = 2(5) + 3 = 10 + 3 = 13 cm<br/>The plant grows 2 cm each week with a starting height of 3 cm.</p>",
