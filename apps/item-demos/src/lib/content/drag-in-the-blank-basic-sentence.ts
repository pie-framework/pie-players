			...
			models: [
				{
					...
					prompt:
						"<p>Complete the sentence by dragging the correct words into the blanks.</p>",
					promptEnabled: true,
					markup:
						"<p>The {{0}} is the largest planet in our solar system, while {{1}} is the smallest.</p>",
					choices: [
						{
							id: "0",
							value: "Jupiter",
					...
					rationale:
						"<p>Jupiter is the largest planet with a diameter of about 86,881 miles, while Mercury is the smallest with a diameter of only 3,032 miles.</p>",
