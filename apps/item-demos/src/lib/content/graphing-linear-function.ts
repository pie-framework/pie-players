...
const demo: DemoInfo = {
	...
	description:
		"Plot points and draw a line through them to represent y = 2x + 1",
			...
			models: [
				{
					...
					prompt:
						"<p>Plot the line for the equation <math><mi>y</mi><mo>=</mo><mn>2</mn><mi>x</mi><mo>+</mo><mn>1</mn></math></p><p>Use points to mark where the line crosses each axis.</p>",
					promptEnabled: true,
					...
					backgroundMarks: [],
					rationale:
						"<p>The line y = 2x + 1 has a slope of 2 and y-intercept of 1. It crosses the y-axis at (0, 1) and passes through points like (2, 5).</p>",
