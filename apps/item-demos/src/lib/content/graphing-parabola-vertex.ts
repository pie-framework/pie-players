...
const demo: DemoInfo = {
	...
	description:
		"Graph a parabola by defining its vertex and a point on the curve",
			...
			models: [
				{
					...
					prompt:
						"<p>Graph the parabola with vertex at (1, -4) that passes through the point (3, 0).</p><p><strong>Hint:</strong> Click the vertex first (root), then click a point on the parabola (edge).</p>",
					promptEnabled: true,
					...
					rationale:
						"<p>The parabola has its vertex (minimum point) at (1, -4) and opens upward. Using the given point (3, 0), we can determine the exact shape of the parabola.</p>",
