...
const demo: DemoInfo = {
	...
	item: {
		...
		config: {
			id: "",
			markup:
				'<graphing-solution-set id="inequality-dashed-line"></graphing-solution-set>',
			elements: {
			...
			models: [
				{
					...
					prompt:
						"Graph the solution set for the inequality: <math>y > 2x - 3</math>",
					promptEnabled: true,
					title: "Linear Inequality with Dashed Boundary",
					rationale:
						"The inequality y > 2x - 3 requires a dashed line (since it's > not ≥) at y = 2x - 3, with the region above the line shaded as the solution set.",
					rationaleEnabled: true,
					teacherInstructions:
						"Students should draw a dashed line through points like (-1, -5) and (2, 1), then select the region above the line as the solution set.",
