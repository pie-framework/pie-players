...
const demo: DemoInfo = {
	...
	description:
		"Algebra question with LaTeX notation testing quadratic formula knowledge",
					...
					choices: [
						{
							...
							feedback: {
								type: "default",
								value:
									"Incorrect. The discriminant should be \\(b^2 - 4ac\\), not \\(b^2 + 4ac\\).",
							},
							rationale:
						...
						},
						{
							...
							feedback: {
								type: "default",
								value:
									"Incorrect. The numerator should start with \\(-b\\), not \\(b\\).",
							},
							rationale:
