...
const demo: DemoInfo = {
	...
	description:
		"Geometry question with LaTeX testing understanding of triangle theorems",
					...
					choices: [
						...
						},
						{
							...
							feedback: {
								type: "default",
								value:
									"Incorrect. The sum of angles in a triangle is \\(180^\\circ\\), not \\(360^\\circ\\).",
							},
							rationale:
						...
						},
						{
							...
							feedback: {
								type: "default",
								value:
									"Correct! This is the standard formula for triangle area.",
							},
							rationale:
						...
						},
						{
							...
							value: "stmt4",
							label:
								"In an equilateral triangle with side length \\(s\\), the area is \\(A = s^2\\)",
							feedback: {
								type: "default",
								value:
									"Incorrect. The area formula for an equilateral triangle is \\(A = \\frac{\\sqrt{3}}{4}s^2\\).",
							},
							rationale:
