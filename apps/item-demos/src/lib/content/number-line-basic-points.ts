...
const demo: DemoInfo = {
	...
	description:
		"Basic point plotting with closed points on an integer number line",
	sourcePackage: "number-line",
	sourceVariantId: "basic-points",
	tags: ["points", "integers", "basic"],
	item: {
		id: "number-line-basic-points",
		name: "Plot Points on Integer Number Line",
		config: {
			...
			models: [
				{
					...
					element: "number-line",
					prompt:
						"<p>Plot the solutions to the equation: <strong>x<sup>2</sup> - 9 = 0</strong></p>",
					correctResponse: [
						{
							type: "point",
							pointType: "full",
					...
					feedback: {
						correct: {
							type: "default",
							default:
								"Correct! The equation x² - 9 = 0 has solutions at x = -3 and x = 3",
						},
						partial: {
							type: "default",
