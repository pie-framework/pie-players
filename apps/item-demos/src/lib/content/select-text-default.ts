...
const demo: DemoInfo = {
	...
	tags: ["select-text", "default", "sentence-mode", "language-arts", "grade-8"],
	item: {
		id: "select-text-default",
		name: "Narrator Reliability Evidence",
		config: {
			...
			models: [
				{
					...
					feedback: {
						correct: {
							type: "default",
							default:
								"Correct. Those two sentences provide evidence that the narrator is unreliable.",
						},
						incorrect: {
							type: "default",
							default:
								"Not quite. Look for specific details showing the narrator changes facts.",
						},
						partial: {
							type: "default",
					...
					mode: "sentence",
					rationale:
						"The strongest evidence is where the narrator is described as unreliable and where specific changed facts are mentioned.",
					prompt:
						"Select the two sentences that best support the claim that the narrator is unreliable.",
					promptEnabled: true,
