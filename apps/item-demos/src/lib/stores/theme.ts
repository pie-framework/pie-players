...
export const THEME_STORAGE_KEY = "pie:item-demos:theme";
export const DEFAULT_THEME = "light";

// Mirrors the theme catalog offered in apps/section-demos so the two demo
// hosts present the same set of DaisyUI themes. The <pie-theme> wrapper maps
// any of these ids onto the --pie-* token contract that PIE content reads.
