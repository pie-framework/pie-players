...
| `section-player` layout and shell | Main layout, passage pane, item pane, shell regions, repeated cards | `1.3.1`, `1.3.2`, `2.4.1`, `2.4.3`, `2.4.6`, `4.1.2` | [Landmark Regions](https://www.w3.org/WAI/ARIA/apg/practices/landmark-regions/), [WCAG 2.4.1](https://www.w3.org/WAI/WCAG22/Understanding/bypass-blocks) | [`../integration/section_player_integration_guide.md`](../integration/section_player_integration_guide.md), [`../integration/assessment-toolkit-section-player-getting-started.md`](../integration/assessment-toolkit-section-player-getting-started.md) |
