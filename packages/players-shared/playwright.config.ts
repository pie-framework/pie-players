 ...
 * `tests/e2e/sanitize-item-markup.spec.ts` for why that distinction matters
 * here specifically: DOMPurify's behavior under happy-dom cannot be trusted,
 * so this is the one place that behavior must be verified for real.
 */
