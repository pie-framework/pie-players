...
<style>
	...
	.items-panel.is-scrolling {
		scrollbar-color: var(--pie-border, #c1c1c1) var(--pie-secondary-background, #f1f1f1);
	}
	...
	.divider-handle {
		...
		width: 6px;
		height: 60px;
		background: var(--pie-border, #9ca3af);
		border-radius: 3px;
	...
	.divider.dragging {
		background: var(--pie-focus-checked, #dbeafe);
	}
